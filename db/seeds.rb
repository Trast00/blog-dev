...
second_comment = Comment.create(text: 'This is my first comment', author_id: first_user.id, post_id: second_post.id)
third_comment = Comment.create(text: 'Helpful Post', author_id: first_user.id, post_id: second_post.id)
fourth_comment = Comment.create(text: 'Well Said', author_id: first_user.id, post_id: second_post.id)
fifth_comment = Comment.create(text: 'RoR is Fun', author_id: second_user.id, post_id: second_post.id)
sixth_comment = Comment.create(text: 'Micronauts Rock', author_id: second_user.id, post_id: second_post.id)
seventh_comment = Comment.create(text: 'Everything is fine', author_id: first_user.id, post_id: second_post.id)
eighth_comment = Comment.create(text: 'Blah Blah Comment', author_id: first_user.id, post_id: second_post.id)
ninth_comment = Comment.create(text: 'Last Comment', author_id: first_user.id, post_id: second_post.id)
like = Like.create( author_id: first_user.id, post_id: second_post.id)
like_two = Like.create( author_id: second_user.id, post_id: second_post.id)
like_two = Like.create( author_id: second_user.id, post_id: first_post.id)